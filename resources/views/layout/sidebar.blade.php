        ...
        @if (Auth::check())
            <div class="navbar-nav w-100">
                ...
                @if (Auth::user()->role === 'admin')
                    <a href="{{ route('transaksi') }}" class="nav-item nav-link {{ Request::routeIs('transaksi') ? 'active' : '' }}">
                        <i class="fas fa-shopping-cart me-2"></i>Transaksi
                    </a>
                    <a href="{{ route('laporan') }}" class="nav-item nav-link {{ Request::routeIs('laporan') ? 'active' : '' }}">
                        <i class="fas fa-file-archive me-2"></i>Laporan Transaksi
                    </a>
